...
import 'package:video_trimmer_native/src/trim_viewer/trim_area_properties.dart';
import 'package:video_trimmer_native/src/trim_viewer/trim_editor_properties.dart';
...
class ScrollableTrimViewer extends StatefulWidget {
  ...
  const ScrollableTrimViewer({
    ...
    this.minVideoLength = const Duration(seconds: 0),
        ...
        Timer.periodic(const Duration(milliseconds: 300), (timer) {
          setState(() {
            ...
            if (isTowardsEnd) {
              ...
              if (_startPos.dx <= _autoStartScrollPos &&
          ...
          log('SCROLL: $currentScrollValue, (${((_scrollController.position
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      ...
      setState(() {
        ...
        if (minVideoLength > const Duration(seconds: 0)) {
          minLengthPixels = (minVideoLength.inMilliseconds /
